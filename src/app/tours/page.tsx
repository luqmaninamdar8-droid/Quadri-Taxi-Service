    ...
    <>
      <section className="relative h-[48vh] min-h-[320px]">
        ...
        <div className="relative mx-auto flex h-full max-w-6xl items-end px-4 pb-12 md:px-6">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Tours</p>
            <h1 className="mt-3 font-display text-5xl">Holiday itineraries, written around you</h1>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-6xl px-4 py-16 md:px-6">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <article key={item.t} className="rounded-2xl border border-white/10 p-5">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {tours.map((tour) => (
            <article key={tour.title} className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8">
